                                ...
                                <div className="flex justify-between items-start mb-3">
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-[#303150] font-bold text-sm mb-1">{goal.name}</span>
                                            <span className="text-xs text-[#7E7F90] font-semibold">
                                                {formatCurrency(goal.currentAmount)} <span className="text-[#BDBDCB] font-medium mx-1">/</span> {formatCurrency(goal.targetAmount)}
                                            </span>
                                        </div>
                                    </div>
